...
@section('rightLink')
				<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Already member?</span> <a href="{{ url('/login') }}" class="btn btn-danger">Sign in</a> </span>
...
@section('content')	
						<div class="well no-padding">
							...
							<form method="POST" action="{{ url('/register') }}" id="smart-form-register" class="smart-form client-form">
								{!! csrf_field() !!}
								<header>
									Register to Learning Machine - its free!
								</header>
								<br>
